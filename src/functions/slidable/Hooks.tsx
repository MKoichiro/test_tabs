...
export const useSlidable = (params: SlidableParamsType) => {
    const { SLIDABLE_LENGTH, GRADIENT_THRESHOLD, TOGGLE_THRESHOLD, COMPLEMENT_ANIME_DURATION } =
        params;
    ...
    const handleTouchMove = (e: TouchEvent<HTMLElement>) => {
        ...
        if (!isSlided) {
            setTranslateX(diffX);
        } // sliding to "Left"  to "Open"
        else {
            setTranslateX(diffX - SLIDABLE_LENGTH);
        } // sliding to "Right" to "Close"
    };
